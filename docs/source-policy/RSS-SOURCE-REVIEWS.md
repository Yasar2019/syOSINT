...
| `enab-baladi-english` | [Enab Baladi English RSS](https://english.enabbaladi.net/feed/) · [homepage](https://english.enabbaladi.net/) | English; `keyword-filtered` | The publisher's [about page](https://english.enabbaladi.net/about-us/) identifies its multilingual Syrian newsroom; the feed links to its articles. On September 25 the feed served 20 parseable items, including Syria headlines dated September 24. Show only attributed original headlines and direct links, never article text or images. Premerge and deployment checks required. |
...
| SANA English | Its homepage carried September reporting, but its general RSS and Syria and latest-news category feeds only served articles dated July 28, 2026 on September 25. Removed in favor of a current feed; revisit if its RSS updates resume. |
| Enab Baladi Arabic | Arabic RSS returned HTTP 403 from GitHub Actions on 2026-09-25. Defer until an accessible feed is confirmed. |
