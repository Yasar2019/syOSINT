...
| `sana-arabic` | [SANA Arabic RSS](https://sana.sy/feed/) · [homepage](https://sana.sy/) | Arabic; `keyword-filtered` | Official Syrian Arab News Agency feed; original headlines link to publisher; no article body or media is copied. Premerge and deployment checks required. |
...
| `enab-baladi-arabic` | [Enab Baladi Arabic RSS](https://enabbaladi.net/feed/) · [homepage](https://enabbaladi.net/) | Arabic; `keyword-filtered` | The publisher's [editorial principles](https://enabbaladi.net/editorial) identify its authorship. Show only original headlines and direct links; no body or media is copied. Premerge and deployment checks required. |
...
| Enab Baladi English | Deferred pending a separately verified English-language feed and publisher attribution record. Arabic headline-and-link RSS is enabled after review. |
