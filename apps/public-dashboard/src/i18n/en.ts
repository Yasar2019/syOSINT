...
export const en = {
  ...
  demo: {
    ...
    body: "The reviewed incidents are fictional demonstration data and do not represent real events or people. The Live News Wire contains real, unverified external publisher headlines.",
  },
  newsWire: {
    title: "Live News Wire",
    disclosure: "Unverified external reporting",
    refreshed: "Last successful refresh",
    ...
    headline: "headline",
    headlines: "headlines",
    sourceDelayed: "This source is delayed; recent coverage may be incomplete.",
    sourceEmpty: "No recent matching reports from this source.",
    noRecentHeadlines: "no recent headlines",
    showMore: "Show more",
    empty: "No matching news reports right now.",
    emptyDelayed: "No recent wire entries are available. This does not mean there are no new reports.",
    delayed: "source delayed",
    stale: "The wire refresh is delayed; headlines may be incomplete.",
    externalLinkContext: "open original report in a new tab",
  },
  filters: {
